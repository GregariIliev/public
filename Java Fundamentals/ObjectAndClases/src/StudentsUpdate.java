...
public class StudentsUpdate {
    ...
    public static boolean checkExistStudentInList(List<Student> studentList, String firstName, String lastName) {
    ...
    public static void main(String[] args) {
        ...
        while (!"end".equals(listOfStudents)) {
            ...
            boolean existStudent = Student.checkExistStudentInList(studentList, firstName, lastName);

            if (existStudent) {
                Student updateStudent = Student.getStudent(studentList, firstName, lastName);

                updateStudent.setFirstName(firstName);
                updateStudent.setLastName(lastName);
                updateStudent.setAge(age);
                updateStudent.setHometown(homeTown);
